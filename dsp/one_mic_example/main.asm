...
.MODULE $sco2_data;
   ...
   .VAR/DM buffer_ola[$plc100.OLA_LEN_WB];
    ...
    .VAR/DM object[$sco_pkt_handler.STRUC_SIZE ] =
                   $SCO_IN_PORT2 | $cbuffer.FORCE_LITTLE_ENDIAN,    // SCO PORT (header)
#if uses_16kHz
                   $SCO_IN_PORT2 | $cbuffer.FORCE_16BIT_DATA_STREAM,// SCO port (payload)
#else
                   $SCO_IN_PORT2 | $cbuffer.FORCE_PCM_AUDIO,        // SCO port (payload)
#endif
                   &port_in.cbuffer_struc,             // INPUT_PTR_FIELD
                   &sco_in.cbuffer_struc,              // OUTPUT_PTR_FIELD:   2
#if uses_PLC
...
#endif
#if uses_16kHz
                   $SCO_OUT_PORT2 | $cbuffer.FORCE_16BIT_DATA_STREAM,   // SCO_OUT_PORT_FIELD (payload)
                   0,                                                  // SCO_OUT_SHIFT_FIELD
#else
                   $SCO_OUT_PORT2 | $cbuffer.FORCE_PCM_AUDIO,           // SCO_OUT_PORT_FIELD (payload)
                   -8,                                                 // SCO_OUT_SHIFT_FIELD
#endif
                   &port_out.cbuffer_struc,                 // SCO_OUT_BUFFER_FIELD
                   30,                                      // SCO_OUT_PKTSIZE_FIELD
