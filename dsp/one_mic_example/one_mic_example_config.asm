...
// fields.
   ...
   .VAR snd_stream_map_sco2_out[$framesync_ind.ENTRY_SIZE_FIELD] =
#if uses_16kHz
      &$sco2_data.encoder.cbuffer_struc,         // $framesync_ind.CBUFFER_PTR_FIELD
#else
      &$sco2_data.port_out.cbuffer_struc,        // $framesync_ind.CBUFFER_PTR_FIELD
#endif
      0,                                        // $framesync_ind.FRAME_PTR_FIELD
      0,                                        // $framesync_ind.CUR_FRAME_SIZE_FIELD
      $one_mic_example.NUM_SAMPLES_PER_FRAME,   // $framesync_ind.FRAME_SIZE_FIELD
...
// is ready to be processed and the reinitialization flag is set.
   .VAR reinitialize_table[] =
    ...
    $frame_sync.sco2_initialize,          &$sco2_data.object,         0,
    0;
