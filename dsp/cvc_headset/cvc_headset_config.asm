...
.MODULE $M.CVC.data;
   ...
   // vad
   .VAR SndDetectDelay = 0;
   .VAR RcvDetectDelay = 0;
...
.CONST $RCV_HARMANCITY_HISTORY_EXTENSION  0;
   ...
   .VAR/DM1 rcv_vad400[$M.vad400.OBJECT_SIZE_FIELD] =
      ...
      0 ...;
#endif
    .VAR/DM2 rcv_vad[$M.stream_vad.STRUC_SIZE] = 
        &stream_map_rcvin,
        &stream_map_rcvin,
        500000,
        &RcvDetectDelay,
...
// mic
.VAR/DM2 snd_vad[$M.stream_vad.STRUC_SIZE] = 
    &stream_map_sndin,
    &stream_map_sndin,
    5000000,
    &SndDetectDelay,
...
#if uses_DCBLOCK    // use it
      $audio_proc.peq.process,                  &sco_dc_block_dm1,      0,
#endif

      // add by grt, sco mute
      $stream_vad,                            &rcv_vad,               0,
