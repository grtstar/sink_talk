...
#ifdef BUILD_MULTI_KAPS // not use
// *****************************************************************************
// MODULE:
//    $flash.init_dmconst
//
...
//
// *****************************************************************************
#ifndef BUILD_MULTI_KAPS    // use here
.MODULE $M.main;
   .CODESEGMENT MAIN_PM;
...
$set_noise_gate_message_handler:
   r1 = r1 LSHIFT 10;
   M[&$M.CVC.data.snd_vad + 2] = r1;
   r2 = r2 LSHIFT 10;
   M[&$M.CVC.data.rcv_vad + 2] = r2;
   rts;
.ENDMODULE;