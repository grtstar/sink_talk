...
#define DEVICE_ID_VENDOR_ID        0x0520   /* As assigned by the appropriate source */
#define DEVICE_ID_PRODUCT_ID       0x1314   /* Customer specific                     */
#define DEVICE_ID_BCD_VERSION      0x1000   /* Where 0xABCD = vAB.C.D                */
