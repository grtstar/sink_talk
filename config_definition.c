...
{
(CONFIG_DATA_CONFIG_SET_TYPE << 12) | 1040,
    (CONFIG_DATA_CONFIG_SET_METADATA_TYPE << 12) | 29,
    0x3431, 0x3161, 0x3936, 0x3433, 0x6338, 0x3139, 0x3934, 0x6139, 0x6666, 0x6363, 0x3731, 0x6466, 0x3739, 0x3638, 0x3636, 0x3839, 
    0, 40492,
    20,
    ...
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 23,
        ...
        0x1200, 0x000a, 0x000a, 0x0005, 0x0005, 0xffff, 0xff00, 0x1f40, 0x0000, 0x000c, 0x0000, 0x0002, 0xafe0, 0x0003, 0x0003, 0x0080, 0x4000, 0xdfda, 0x0a0a, 0xc000,
        (CONFIG_DATA_PS_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
        9,
    ...
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 69,
        (CONFIG_DATA_CONFIG_BLOCK_DATA_TYPE << 12) | 66,
        0x0001, 0x0038, 0xbe03, 0x0001, 0x0038, 0xbd08, 0x0000, 0xfffd, 0x9506, 0x0000, 0xfffd, 0x9607, 0x0000, 0xfff8, 0x0d01, 0x0000, 0xfff8, 0x0d05, 0x0000, 0xfff8, 0x0e01, 0x0000, 0xfff8, 0x0e05, 0x0000, 0x0038, 0x0c01, 0x0001, 0x7ffe, 0x8f02, 0x0001, 0x8029, 0x2104, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        (CONFIG_DATA_PS_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
        23,
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 17,
        (CONFIG_DATA_CONFIG_BLOCK_DATA_TYPE << 12) | 14,
        0xffba, 0xffc4, 0x0005, 0x0000, 0x0000, 0xffdd, 0x0005, 0x080f, 0x0080, 0x0800, 0x0012, 0x0800, 0x0012, 0x0078,
        (CONFIG_DATA_PS_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
        24,
    ...
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 21,
        (CONFIG_DATA_CONFIG_BLOCK_DATA_TYPE << 12) | 18,
        0x4001, 0x0b00, 0x4002, 0x0c00, 0x4019, 0x0e00, 0x401a, 0x0d00, 0x4744, 0x0a00, 0x4745, 0x0100, 0x473d, 0x3c00, 0x400d, 0x0400, 0x400e, 0x0300,
        (CONFIG_DATA_PS_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
        35,
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 4,
        (CONFIG_DATA_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
