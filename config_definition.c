...
{
(CONFIG_DATA_CONFIG_SET_TYPE << 12) | 1143,
    (CONFIG_DATA_CONFIG_SET_METADATA_TYPE << 12) | 29,
    0x6639, 0x3439, 0x6533, 0x3034, 0x3763, 0x6233, 0x6239, 0x6530, 0x3930, 0x3634, 0x6538, 0x6334, 0x6538, 0x6634, 0x6561, 0x6130, 
    0, 41538,
    20,
    ...
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 69,
        (CONFIG_DATA_CONFIG_BLOCK_DATA_TYPE << 12) | 66,
        0x0000, 0xfffa, 0x0203, 0x0000, 0x0006, 0x0102, 0x0001, 0xfff8, 0xb902, 0x0001, 0x0010, 0xb808, 0x0001, 0x0029, 0xba08, 0x0000, 0xfffd, 0x9506, 0x0000, 0xfffd, 0x9607, 0x0004, 0xfff8, 0x0d01, 0x0004, 0xfff8, 0x0d05, 0x0002, 0xfff8, 0x0e01, 0x0002, 0xfff8, 0x0e05, 0x0006, 0x7d40, 0x0c01, 0x0001, 0x7ffe, 0x8f0b, 0x0003, 0x0006, 0x220b, 0x0001, 0x0020, 0xc204, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        (CONFIG_DATA_PS_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
        23,
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 17,
        (CONFIG_DATA_CONFIG_BLOCK_DATA_TYPE << 12) | 14,
        0xffba, 0xffdd, 0x0005, 0x0000, 0x0000, 0xffdd, 0x0005, 0x200a, 0x0020, 0x0800, 0x0012, 0x0800, 0x0012, 0x0078,
        (CONFIG_DATA_PS_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
        24,
    ...
    (CONFIG_DATA_CONFIG_BLOCK_TYPE << 12) | 24,
        ...
        0x4001, 0xfffc, 0x0000, 0x4002, 0xfffc, 0x0100, 0x4003, 0xfffc, 0x0200, 0x4701, 0xfffc, 0x0300, 0x4700, 0xfffc, 0x0400, 0x4715, 0xfffc, 0x0500, 0x4716, 0xfff8, 0x0600,
        (CONFIG_DATA_PS_CONFIG_BLOCK_DATA_TYPE << 12) | 1,
        34,
