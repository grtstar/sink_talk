...
config_build : $(SRC_DIR)/global_config.xml $(MODULE_DEFINITIONS)
	$(CONFIG_BUILD_EXE_CMD) -s $(PLATFORM) -g $(SRC_DIR)/global_config.xml -ocd $(CONFIG_DEFINITION) -o $(SRC_DIR)/ $(MODULE_DEFINITIONS) -vvv -psk 6-49,150-190 -pm $(SRC_DIR)/pskey_map.xml -hw $(HW_VARIANT) -sw $(SW_VARIANT) -l $(SRC_DIR)/config_build.log
