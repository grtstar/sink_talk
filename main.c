...
/* BLE Messages */
        ...
        case CL_DM_BLE_ACCEPT_CONNECTION_PAR_UPDATE_IND:
        {
            ...
            MAIN_DEBUG(("CL_DM_BLE_ACCEPT_CONNECTION_PAR_UPDATE_IND conn_interval_min [0x%x], conn_interval_max [0x%x] \n", req->conn_interval_min, req->conn_interval_max));
        ...
        {
            MAIN_DEBUG(("CL_DM_BLE_CONNECTION_UPDATE_COMPLETE_IND status %d, CI [0x%x] \n", ((const CL_DM_BLE_CONNECTION_UPDATE_COMPLETE_IND_T*)message)->status,
        ...
        {
            MAIN_DEBUG(("CL_SM_BLE_SIMPLE_PAIRING_COMPLETE_IND [0x%x]\n",
...
static void handleUEMessage  ( Task task, MessageId id, Message message )
{
    ...
    switch ( id )
    {
        ...
        case (EventUsrInitateVoiceDial):
            ...
            {
                static uint16 id = 0;
                MAIN_DEBUG(("HS: Play Tone [%d]\n", id));
                AudioPromptPlay((TaskData *)&csr_voice_prompts_plugin, (uint16) id++, TRUE, FALSE);
            }
            break;
        ...
        case ( EventUsrRssiPair ):
            ...
            lIndicateEvent = inquiryPair( inquiry_session_normal, TRUE );   /* TRUE means disconnect all connections */
        break;
